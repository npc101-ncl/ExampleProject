<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="27" versionDevel="217" copasiSourcesModified="0">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="/Users/peter/Documents/GitHub/ExampleProject/example_project/models/ProfileLikelihoods/Fit1/ES/ParameterEstimationData/PEData0.txt" reference="Report_46" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter type="unsignedInteger" name="Number of steps" value="10"/><Parameter type="cn" name="Object" value="CN=Root,Model=NoName,Vector=Compartments[cytoplasm],Vector=Metabolites[ES],Reference=InitialConcentration"/><Parameter type="unsignedInteger" name="Type" value="1"/><Parameter type="float" name="Maximum" value="0.0"/><Parameter type="float" name="Minimum" value="0.0"/><Parameter type="bool" name="log" value="1"/></ParameterGroup></ParameterGroup>

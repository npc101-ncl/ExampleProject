<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="27" versionDevel="217" copasiSourcesModified="0">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="/Users/peter/Documents/GitHub/ExampleProject/example_project/models/ProfileLikelihoods/Fit1/S/ParameterEstimationData/PEData0.txt" reference="Report_82" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter type="unsignedInteger" name="Number of steps" value="10"/><Parameter type="cn" name="Object" value="CN=Root,Model=NoName,Vector=Compartments[cytoplasm],Vector=Metabolites[S],Reference=InitialConcentration"/><Parameter type="unsignedInteger" name="Type" value="1"/><Parameter type="float" name="Maximum" value="10000.001549282924"/><Parameter type="float" name="Minimum" value="0.010000001549282924"/><Parameter type="bool" name="log" value="1"/></ParameterGroup></ParameterGroup>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter type="cn" name="UpperBound" value="1000000"/>
            <Parameter type="float" name="StartValue" value="0.1"/>
            <Parameter type="cn" name="ObjectCN" value="CN=Root,Model=NoName,Vector=Compartments[cytoplasm],Vector=Metabolites[EI],Reference=InitialConcentration"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments"/>
            <ParameterGroup name="Affected Cross Validation Experiments"/>

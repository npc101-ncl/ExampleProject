<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="27" versionDevel="217" copasiSourcesModified="0">
      ...
      <MiriamAnnotation>
        <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
          <rdf:Description rdf:about="#Function_39">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2019-12-10T15:44:43Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="/Users/peter/Documents/GitHub/ExampleProject/example_project/models/Problem1/Fit1/myToyModel/ParameterEstimationData/PEData0.txt" reference="Report_53" confirmOverwrite="0"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="5"/>
        <ParameterGroup name="ScanItems">
        <ParameterGroup name="ScanItem"><Parameter type="unsignedInteger" name="Number of steps" value="1"/><Parameter type="unsignedInteger" name="Type" value="0"/><Parameter type="cn" name="Object" value="CN=Root,Model=NoName,Vector=Compartments[cytoplasm],Vector=Metabolites[S],Reference=InitialConcentration"/></ParameterGroup></ParameterGroup>
    ...
    <Task key="Task_19" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="0">
      ...
      <Problem>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="toyModelCalData">
            <Parameter type="key" name="Key" value="Experiment_toyModelCalData"/>
            <Parameter type="file" name="File Name" value="/Users/peter/Documents/GitHub/ExampleProject/example_project/models/toyModelCalData.csv"/>
